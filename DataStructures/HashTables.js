...
// A good hash should be fast, distribute keys uniformly, and be deteministic
// Separate chaining and linear probing are two strategies used to deal with two keys that hash to the same index
// Separate chaining - put duplicates in the same slot nested
// Linear probing - Look ahead for the next availible slot
